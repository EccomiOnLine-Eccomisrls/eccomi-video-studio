...
print(">>> CONTAINER AVVIATO: V88 (YACS & Config Fix)...", flush=True)

def install_essentials():
    print(">>> 1. Installazione librerie mancanti (YACS)...", flush=True)
    target_dir = "/tmp/custom_libs"
    os.makedirs(target_dir, exist_ok=True)
    
    # Aggiungiamo yacs e pyyaml che bloccano il caricamento dei file .yaml
    libs = [
    ...
    print(">>> 2. RE-WRITING: Pulizia codice finale...", flush=True)
...
def handler(job):
    ...
    try:
        ...
        print(">>> AVVIO RENDERING AI (V88)...", flush=True)
        ...
        return {"error": "Rendering finito. Nessun video generato."}
