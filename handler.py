...
print(">>> CONTAINER AVVIATO: V90 (The Final Piece)...", flush=True)

def install_essentials():
    target_dir = "/tmp/custom_libs"
    os.makedirs(target_dir, exist_ok=True)
    
    # Aggiunti librosa e resampy per il processing audio
    libs = [
    ...
    # RIPETIAMO LA CHIRURGIA CHE HA FUNZIONATO NELLA V89
    print(">>> Esecuzione Chirurgia Anti-Torchvision...", flush=True)
...
def handler(job):
    ...
    try:
        ...
        print(">>> AVVIO RENDERING AI (V90)...", flush=True)
        ...
        return {"error": "Rendering completato. Nessun video trovato."}
